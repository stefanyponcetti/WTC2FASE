package com.example.wtcapp.repositories

import com.example.wtcapp.data.ChatMessage
import com.example.wtcapp.services.RetrofitClient
...
class ChatRepository(private val jwtToken: String) {
    ...
    suspend fun getHistory(chatId: String): List<ChatMessage> {
        return RetrofitClient.api.getHistory("Bearer $jwtToken", chatId)
    }
}
